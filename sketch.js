...
// change the random color of the particles if h<55,else change the color to theme color
...
//   particles.theme = random([
//     {
//     colors:[ "#CD5C5C", "#FFE4E1", "#E6D933", "	#33E6CC", "#7400A1"],
    

// background: "#ffffff" },]);
// console.log(particles.theme);
// let newtheme = random([{colors:[ "#CD5C5C", "#FFE4E1", "#f20732", "	#24f0d2", "#7400A1"], },]);
// createParticles(newtheme);
// particles.forEach((p) => {
//   let newtheme = random([{colors:[ "#CD5C5C", "#FFE4E1", "#f20732", "	#24f0d2", "#7400A1"], },]);
//      p.createParticles(newtheme);
//     });
// }else{
